...
Run a test with our events
```bash
./bin/EventTest [min_points] [min_cluster_size] [optional: eNum]
```

It will look for an a file with the name "event_{eNum}.dat" in the dataset folder.
