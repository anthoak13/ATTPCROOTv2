...
Bool_t  AtTpc::ProcessHits(FairVolume* vol)
{
  ...
  */
  ...
  if (gMC->IsTrackEntering())
  {
    ...
    LOG(INFO) << " Initial energy of the current particle in this volume : "
...
//            return kFALSE;
    ...
    } // end if track exiting

  }// if track is going away
     ...
     (fVolName=="drift_volume" || fVolName=="cell"))
  {
    ...
    LOG(INFO)<<" Total energy of the Beam particle before reaction : "<<StopEnergy<<FairLogger::endl;
    gATVP->SetVertex(StopPos.X(),StopPos.Y(),StopPos.Z(),
