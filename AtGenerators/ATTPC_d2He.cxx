...
Bool_t ATTPC_d2He::ReadEvent(FairPrimaryGenerator* primGen) {
  ...
  for(Int_t i=0; i<fMult; i++){
    ...
    if(i>1 && i!=3 && !gATVP->IsBeamEvt() && pdgType!=1000500500 && fPType.at(i)=="Ion" ){
    ...
    }else if(i>1 && i!=3 && !gATVP->IsBeamEvt() && pdgType==2212 && fPType.at(i)=="Proton" ){
    ...
    }else if(i>1 && i!=3 && !gATVP->IsBeamEvt() && pdgType==2112 && fPType.at(i)=="Neutron" ){
