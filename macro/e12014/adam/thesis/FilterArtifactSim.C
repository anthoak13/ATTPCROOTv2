void FilterArtifactSim(int cuttoff)
{
   TString inOutDir = "./data/";
   TString outputFile = inOutDir + TString::Format("output_digi%d.root", cuttoff);
   ...
   AtRawEvent *respAvgEvent = (AtRawEvent *)f2->GetObjectChecked("avgResp", "AtRawEvent");
   cout << respAvgEvent;
   ...
   pulse->SetResponse(ElectronicResponse::AtRootResponse(0.32, *respAvgEvent));
