...
void TS_corr(int runNumberS800 = 8, int runNumberATTPC = 8)
{
  ...
  //Set the input file
  TString inputFile = TString::Format("/mnt/daqtesting/e21018_attpc_transfer/h5/run_%04d.h5", runNumberATTPC);

  //Set the output file
  //TString outputFile = TString::Format("run_%04d_test_e21018.root", runNumberATTPC);
  //TString outputFile = TString::Format("/mnt/analysis/e21018/rootMerg/run_%04d_e21018.root", runNumberATTPC);
  TString outputFile = TString::Format("/mnt/analysis/e21018/rootMerg/run_%04d_e21018.root", runNumberATTPC);
...
// unpackTask->SetPersistence(true); // true keeps AtRawEvent
 ...
 // HDFParserTask->SetAuxChannel(hash, "IonCb_34");
  ...
  TString S800File = TString::Format("/mnt/analysis/e21018/rootS800/cal/run-%04d-00.root", runNumberS800);
