...
static Double_t proj_mass = 31.999110 * 931.494 - 0.511 * 8.; //33Al
static Double_t target_mass = 2.01410177812 * 931.494;
static Double_t recoil_mass = 32.020010 * 931.494 - 0.511 * 7.; //33Mg
...
void ana_d2He_32mg(Int_t runNumber)
{
   ...
   TFile *outfile;
   TString outFileNameHead = TString::Format("/mnt/analysis/e21018/rootAna/Mustak/run_2%03d_%04d.root", runNumber, runNumber);
