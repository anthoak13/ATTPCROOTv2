...
void ana_d2He_32mg(Int_t runNumber)
{
   ...
   //TString digiFileName = TString::Format("/mnt/analysis/e21018/rootMerg/run_2%03d_%04d.root", runNumber, runNumber);
   TString digiFileName = TString::Format("/mnt/analysis/e21018/rootMerg/run_0033_e21018.root");
   ...
   TFile *outfile;
   TString outFileNameHead = TString::Format("/mnt/analysis/e21018/rootAna/Zarif/run_0033_e21018.root");
   ...
   for (Int_t i = 0; i < nEvents; i++) {
      ...
      if (patternEvent) {
         ...
         for (size_t ive = 0; ive < NVtxEvt; ive++) {
            ...
            if (charge1 < 0 || charge2 < 0 || MaxR1 > 245. || MaxR2 > 245. || MaxR1 < 35. || MaxR2 < 35. ||
